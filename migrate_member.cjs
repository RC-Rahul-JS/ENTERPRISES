...
const envContent = `VITE_API_BASE_URL=https://api.care2connect.in
VITE_API_URL=https://api.care2connect.in/badri_enterprises
VITE_LOCALPRIME_URL=https://api.care2connect.in/badri_enterprises/localprime
