...
// Defined in .env  →  VITE_LOCALPRIME_URL=http://192.168.29.145:5000/badri_enterprises/localprime
export const BASE_URL = import.meta.env.VITE_LOCALPRIME_URL;

// Top-level API URL (without /localprime)
// Defined in .env  →  VITE_API_URL=http://192.168.29.145:5000/badri_enterprises
export const API_URL = import.meta.env.VITE_API_URL;

// Raw server base (host only)
// Defined in .env  →  VITE_API_BASE_URL=http://192.168.29.145:5000
