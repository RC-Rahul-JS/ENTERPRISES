...
// Defined in .env  →  VITE_LOCALPRIME_URL=http://192.168.29.39:5001/badri_enterprises/localprime
export const BASE_URL = import.meta.env.VITE_LOCALPRIME_URL || 'http://192.168.29.8:5001/badri_enterprises/localprime';

// Top-level API URL (without /localprime)
// Defined in .env  →  VITE_API_URL=http://192.168.29.8:5001/badri_enterprises
export const API_URL = import.meta.env.VITE_API_URL || 'http://192.168.29.8:5001/badri_enterprises';

// Raw server base (host only)
// Defined in .env  →  VITE_API_BASE_URL=http://192.168.29.8:5001
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://192.168.29.8:5001';
