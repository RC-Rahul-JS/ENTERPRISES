  ...
  const handleSubmit = async() => {
    ...
    const payload = {
     ...
     try {
      ...
      // const formattedCredit =addedList.map(c => ({
...
//       };
//       console.log(voucher)
      const res=await postData('/payment_voucher',voucher)
      Swal.fire({
        title: "Successful",
  ...
  return (
    <div style={s.wrapper}>
      <div style={s.container}>
        <div style={s.header}>
          <div style={s.title}>Payment Entry Portal</div>
        ...
        <li className="px-4 py-2 text-gray-500 text-sm">No matches</li>
          ...
          <div style={s.row2}>
            <div style={s.inputGroup}>
              ...
              <input type="number" onWheel={(e) => e.target.blur()} style={s.input} placeholder="0.00" value={amount} onChange={(e) => setAmount(e.target.value)} />
            </div>
...
<div style={s.inputGroup}>
            ...
            <div style={{textAlign:'right'}}>
              ...
              <button style={s.submitBtn} onClick={handleSubmit}>Submit Payroll</button>
            </div>
          </div>
