...
const WalletWithdrawal = () => {
  ...
  // ── Top Header / Wallet Withdrawal Section ────────────────────────────────
  ...
  const [creditTo, setCreditTo] = useState('Cash in hand');
  ...
  useEffect(() => {
    const fetchDropdowns = async () => {
      try {
        ...
        console.error('[WalletWithdrawal] Error fetching branches:', err);
      }
  ...
  // ── Submit / Create Withdrawal Handler ────────────────────────────────────
    ...
    <div className="min-h-screen p-4 sm:p-6 bg-slate-50">
      <div className="max-w-7xl mx-auto shadow-sm rounded-lg border border-gray-200 bg-white overflow-hidden">
        <form onSubmit={handleSubmit} className="space-y-0">
          ...
          >
            {/* Top Row Fields: Branch Name, Date, Wallet A/c No, Name, Branch, Balance */}
            ...
            <div className="rounded border border-gray-200">
              ...
              <div className="p-4 bg-white">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    <label className={labelCls}>Credit To</label>
                    <select
                      value={creditTo}
            ...
            {/* ── Section 3: Pay Amount (Withdrawal Amount) ───────────────────── */}
            <div className="rounded border border-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Amount"
                      className={`${inputCls} font-extrabold text-red-600 bg-red-50/30 text-sm`}
                    />
                  </div>
                </div>
              </div>
